...
'''Typeclass instance definitions for the 'function' type'''

from typeclasses import instance
from typeclasses.functor import Functor

# We need a reference to the 'function' type to be able to register typeclass
# instances
function = type(lambda: None)

instance(Functor, function, lambda f, o: lambda x: f(o(x)))
